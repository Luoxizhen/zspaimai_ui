...
class TgitClient(object):
    ...
    def update_groups_members(self, id, user_id, **kwargs):
        ...
        """
        return self.put(
            "/groups/:id/members/:user_id", id=id, user_id=user_id, **kwargs
        )
    ...
    def create_groups_projects(self, id, project_id, **kwargs):
        ...
        """
        return self.post(
            "/groups/:id/projects/:project_id", id=id, project_id=project_id, **kwargs
        )
    ...
    def update_projects_issues(self, id, issue_id, **kwargs):
        ...
        """
        return self.put(
            "/projects/:id/issues/:issue_id", id=id, issue_id=issue_id, **kwargs
        )
    ...
    def get_projects_issues_subscribe(self, id, issue_id, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/issues/:issue_id/subscribe",
            id=id,
            issue_id=issue_id,
            **kwargs
        )
    ...
    def get_projects_repository_raw_blobs(self, id, sha, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/repository/raw_blobs/:sha", id=id, sha=sha, **kwargs
        )
    ...
    def list_projects_branches_protected_members(
        self, id, protected_branch_name, **kwargs
    ):
        """
    ...
    def get_projects_releases(self, id, tag_name, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/releases/:tag_name", id=id, tag_name=tag_name, **kwargs
        )
    ...
    def create_projects_releases_attachments(self, id, tag_name, **kwargs):
        ...
        """
        return self.post(
            "/projects/:id/releases/:tag_name/attachments",
            id=id,
            tag_name=tag_name,
            **kwargs
        )

    def get_projects_releases_attachments(
        self, id, tag_name, attachment_name, **kwargs
    ):
        """
    ...
    def delete_projects_releases_attachments(
        self, id, tag_name, attachment_name, **kwargs
    ):
        """
    ...
    def get_projects_repository_commits(self, id, sha, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/repository/commits/:sha", id=id, sha=sha, **kwargs
        )
    ...
    def get_projects_repository_commits_diff(self, id, sha, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/repository/commits/:sha/diff", id=id, sha=sha, **kwargs
        )
    ...
    def create_projects_repository_commits_comments(self, id, sha, **kwargs):
        ...
        """
        return self.post(
            "/projects/:id/repository/commits/:sha/comments", id=id, sha=sha, **kwargs
        )
    ...
    def list_projects_repository_commits_refs(self, id, sha, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/repository/commits/:sha/refs", id=id, sha=sha, **kwargs
        )
    ...
    def update_projects_members(self, id, user_id, **kwargs):
        ...
        """
        return self.put(
            "/projects/:id/members/:user_id", id=id, user_id=user_id, **kwargs
        )
    ...
    def delete_projects_share(self, id, group_id, **kwargs):
        ...
        """
        return self.delete(
            "/projects/:id/share/:group_id", id=id, group_id=group_id, **kwargs
        )
    ...
    def update_projects_hooks(self, id, hook_id, **kwargs):
        ...
        """
        return self.put(
            "/projects/:id/hooks/:hook_id", id=id, hook_id=hook_id, **kwargs
        )
    ...
    def update_projects_merge_requests_notes(
        self, id, merge_request_id, note_id, **kwargs
    ):
        """
    ...
    def get_projects_merge_requests_notes(
        self, id, merge_request_id, note_id, **kwargs
    ):
        """
    ...
    def create_projects_issues_notes(self, id, issue_id, **kwargs):
        ...
        """
        return self.post(
            "/projects/:id/issues/:issue_id/notes", id=id, issue_id=issue_id, **kwargs
        )
    ...
    def create_projects_merge_request_review_invite(
        self, id, merge_request_id, **kwargs
    ):
        """
    ...
    def delete_projects_merge_request_review_dismissals(
        self, id, merge_request_id, **kwargs
    ):
        """
    ...
    def delete_projects_merge_request_review_cancel(
        self, id, merge_request_id, **kwargs
    ):
        """
    ...
    def update_projects_merge_request_reviewer_summary(
        self, id, merge_request_id, **kwargs
    ):
        """
    ...
    def update_projects_merge_request_review_reopen(
        self, id, merge_request_id, **kwargs
    ):
        """
    ...
    def get_projects_review(self, id, review_id, **kwargs):
        ...
        """
        return self.get(
            "/projects/:id/review/:review_id", id=id, review_id=review_id, **kwargs
        )
    ...
    def create_projects_review_invite(self, id, review_id, **kwargs):
        ...
        """
        return self.post(
            "/projects/:id/review/:review_id/invite",
            id=id,
            review_id=review_id,
            **kwargs
        )
    ...
    def delete_projects_review_dismissals(self, id, review_id, **kwargs):
        ...
        """
        return self.delete(
            "/projects/:id/review/:review_id/dismissals",
            id=id,
            review_id=review_id,
            **kwargs
        )
    ...
    def update_projects_review_reviewer_summary(self, id, review_id, **kwargs):
        ...
        """
        return self.put(
            "/projects/:id/review/:review_id/reviewer/summary",
            id=id,
            review_id=review_id,
            **kwargs
        )
    ...
    def update_projects_review_reopen(self, id, review_id, **kwargs):
        ...
        """
        return self.put(
            "/projects/:id/review/:review_id/reopen",
            id=id,
            review_id=review_id,
            **kwargs
        )
