...
from ..command_line import check_at_env
...
class JavaDriver(basedriver.JavaBaseDriver):
    ...
    def _init(self, open_atstub=False):
        ...
        try:
            ...
            if self.uiautomator_version == config.UIAUTOMATOR2 and open_atstub:
                time.sleep(3)
