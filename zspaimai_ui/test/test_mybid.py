...
class TestMybidInfo:
    ...
    def test_good_in_all_bid(self):
        ...
        assert info == {"good_name":"拍品2","good_status":"流拍","good_price":"￥10.00","good_bid_n":"1次出价","my_status_of_good":"出局"}
        assert info_2 == {"good_name":"拍品3","good_status":"已结束","good_price":"￥1000.00","good_bid_n":"3次出价","my_status_of_good":"中标"}
        assert info_3 == {"good_name":"拍品1","good_status":"进行中","good_price":"￥205.00","good_bid_n":"13次出价","my_status_of_good":"领先"}
    ...
    def test_pay(self):
        ...
        assert self.mb.all_to_pay() == "￥225.5"
        self.mb.select("一","取消")
