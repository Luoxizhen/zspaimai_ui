...
class MiniumObject(object,metaclass=MonitorMetaClass):
 ...
 def mock_wx_method(self,method,result,success=True):
  self._mock_wx_method(method=method,result=result,success=success)
 ...
 def _mock_wx_method(self,method,result,success=True):
